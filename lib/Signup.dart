...
class _SignupState extends State<Signup> {
                ...
                Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        for(i=0;i<(MediaQuery.of(context).size.width/4).toInt()-100;i++)
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text("Login",style: TextStyle(///done thhav
  ...
  Future<void> _getAvailableBiometrics() async {
    try {
      ...
      if (availableBiometrics!.contains(BiometricType.weak) || availableBiometrics!.contains(BiometricType.face)) {
        final bool didAuthenticate = await auth!.authenticate(
            localizedReason: 'Unlock your screen with PIN, pattern, password, face, or fingerprint',
